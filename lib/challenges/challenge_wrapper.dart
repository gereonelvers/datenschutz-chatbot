...
class _ChallengeWrapperState extends State<ChallengeWrapper> with TickerProviderStateMixin {
  ...
  generateChallenges(int difficulty) {
    setState(() {
      ...
      challenges.add(
        MatchingChallenge(
          const ["Die Person, auf die sich die Informationen in den personenbezogenen Daten bezieht und jede identifizierbare oder identifizierte Person, deren Daten erhoben und verarbeitet werden", "Jede Person/ jede Einrichtung, die personenbezogene Daten für sich oder andere erhebt oder darüber entscheidet (der oder die was mit den Daten macht = Datenverarbeitung)", "Jede Person/Einrichtung, außer der betroffenen Person, dem Verantwortlichen, dem Auftragsverarbeiter und den Personen, die unter der unmittelbaren Verantwortung des Verantwortlichen oder des Auftragsverarbeiters befugt sind, die personenbezogenen Daten zu verarbeiten"],
      ...
      challenges.add(QuizChallenge(
          ...
          const ["Nein, da der Online-Händler noch ein berechtigtes Interesse anmeinen Daten hat (z.B. für Werbezwecke)", "Nein, da du deine Zustimmung zur Verarbeitung deiner Daten gegeben hast und diese weiter besteht", "Ja, aber nach einer Haltefrist von 10 Jahren, da sie noch für steuerliche Zwecke benötigt werden", "Ja, unverzüglich, da der Zweck der Erhebung nicht mehr besteht"],
          const [2],
          5,
          true,
          key: UniqueKey()));
      ...
      challenges.add(QuizChallenge(
          ...
          const ["Ja, er ist schließlich für die Daten verantwortlich", "Nein, das ist technisch nicht möglich", "Jein, er muss zumindest die Verantwortlichen der Links & Backups über die Löschaufforderung informieren, falls technisch möglich und angemessen", "Jein, er muss selbst, falls technisch möglich und angemessen, alle Links & Backups entfernen"],
          const [2],
          5,
          true,
          key: UniqueKey()));
      ...
      challenges.add(QuizChallenge(
        ...
        const ["Namen", "Kennnummer", "Standortdaten", "Online-Kennung (IP-Adresse)", "physische Merkmale", "physiologischen Merkmal", "genetische Merkmale", "psychischen Merkmale", "wirtschaftliche Merkmale", "kulturelle Identität", "soziale Identität", "randomisierte Nummer", "fiktiver Avatar, den auch mehrere Spieler gleichzeitig spielen können"],
      ...
      challenges.add(QuizChallenge(
        ...
        const ["Name und Kontakt des Verantwortlichen", "Kontakt des Datenschutzbeauftragten", "Zweck der Verarbeitung", "Empfänger", "Absicht des Verantwortlichen", "Dauer der Speicherung", "sämtliche Rechte", "technische Verarbeitungsweise", "Standort des Speichermediums", "Hardwareinfo des Verantwortlichen", "Kategorien der Daten", "wenn sie indirekt von dir erhoben werden"],
      ...
      challenges.add(QuizChallenge(
        ...
        const ["Verarbeitungszweck", "Kategorien der Daten", "Dauer", "Empfänger", "bestehende Rechte", "Bestätigung, ob betreffende Daten verarbeitet werden", "Kopie der personenbezogenen Daten", "technische Verarbeitungsweise", "Standort des Speichermediums", "Hardwareinfo des Verantwortlichen", "Kategorien der Daten"],
      ...
      challenges.add(QuizChallenge(
        ...
        const ["Erheben", "Erfassen", "Organisation", "Ordnen", "Speicherung", "Anpassung", "Veränderung", "Auslesen", "Abfragen", "Verwendung", "Offenlegung", "Übermittlung", "Bereitstellung", "Abgleich", "Verknüpfung", "Einschränkung", "das Löschen", "Vernichtung"],
