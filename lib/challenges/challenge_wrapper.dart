...
class _ChallengeWrapperState extends State<ChallengeWrapper> with TickerProviderStateMixin {
  ...
  List<Challenge> challengeLibrary = [
    ...
    MatchingChallenge(const ["betroffene Person","freiwillig, für den bestimmten Fall, in informierter Weise, unmissverständlich","Willensbekundung, Erklärung, eindeutigen bestätigenden Handlung","zum Einverständnis der Verarbeitung ihrer personenbezogenen Daten"], const ["Wer?", "Wie?", "Was?", "Warum?"], key: UniqueKey(),),
